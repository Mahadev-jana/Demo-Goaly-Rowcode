...
import noDataImg from '../../assetsStaging/img/no_data_found2.png';
                ...
                <>
                    {matches.length >= 1 ?
                        ...
                        <div className="container" style={{ display: 'flex', justifyContent: 'center', alignItems: 'center', height: '280px' }}>
                            <img style={{ height: '200px' }} src={noDataImg} alt="Transparent MDB Logo" id="animated-img1" />
                        </div>
                    }
                </>
            }
...
const Completionist = () => {
    return(
        <div>
            ...
            <br></br>
            <div className="btn-pill bg-red" style={{ width: "120px" }}>Finished</div>
        </div>)
};
...
const renderer = ({ days, hours, minutes, seconds, completed }) => {
    if (completed) {
        ...
        // Render a countdown
        return <div>
            <h3 className="my-1" style={{ fontSize: '12px' }}><strong>{days}d:{hours}h:{minutes}m:{seconds}s</strong></h3>
            <div className="btn-pill bg-green" style={{ width: "120px" }}>Coming Soon</div>
        </div>;
    }
};

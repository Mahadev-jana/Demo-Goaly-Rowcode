...
const LeagueInfo = (props) => {
    ...
    useEffect(()=>{
        console.log("topplayer length is" + topPlayers.length)
    },[])
                ...
                <div className="league-highlight block bg-grey">
                   {!turnament && <h5>Season {seasonName}</h5>}
                    ...
                    {!turnament ?
                        ...
                        <img style={{ height: '80px' }} src={noDataImg} alt="Transparent MDB Logo" id="animated-img1" />
            </div>
            :
            null
                    }
                ...
                <div className="league-top-player">
                   ...
                   <div className="p-2 bg-white">
                    ...
                    <div className="container" style={{ display: 'flex', justifyContent: 'center', alignItems: 'center', height: '180px' }}>
                                <img style={{ height: '100px' }} src={noDataImg} alt="Transparent MDB Logo" id="animated-img1" />
                            </div>
            }
                </div>

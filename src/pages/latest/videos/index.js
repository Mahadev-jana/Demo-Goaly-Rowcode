                    ...
                    {openList && leagues &&
                        <ul className="dropdown-menu w-100" aria-labelledby="dropdownMenu2" style={{ display: 'block', margin: '-12px 0' }}>
                            ...
                            leagues.map((league, key) => {
                                    ...
                                    return <li key={key} onClick={() => { this.getFilterByLeague(league.sportsmonks_id, league.competition_name),this.video_id(league.competition_id) ,this.spreadList(),this.setState({limit:5}) }}><a>{league.competition_name}</a></li>

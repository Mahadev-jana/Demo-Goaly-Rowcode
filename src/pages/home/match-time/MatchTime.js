            ...
            <React.Fragment>
                ...
                <ul className="filter-dayss">
                    <li onClick={() => { this.getWeeklyPrediction() }}
                        className={period === 'weekly' ? "btn border radius-1 filter-dayss-active" : 'btn border radius-1'}>Weekly</li>
                    <li onClick={() => { this.getMonthlyPrediction() }}
                        className={period === 'monthly' ? "btn border radius-1 filter-dayss-active" : 'btn border radius-1'}>Monthly</li>

...
import prize7 from '../../../assets/img/slider/Contest Page Banner/demo-goaly-banner-2.png';
            ...
            sportLockerLogin () {
                if( isAuthenticate()){
                    if(getUserDetails().subscription_status === "subscribed") {
                        ...
                        axios.post("https://cms.goaly.mobi/StageGoalyApi/sportlock_register",payload)
                        .then(res=>{

...
const NewCurrentPredictionCard = React.memo(({ venue_image, isLoading, awayteam, awayteamid, awayteamlogo, hometeam, hometeamid, hometeamlogo, id,
    match_id, league_id, competition_id, league_logo, match_start, players, pred_end, pred_start, venue, history, currentDate, score_home, score_away, status, winPoint, type, news, urlToImage, content, publishedAt, matchList, matchs, away_team_short_code, home_team_short_code
}) => {
            ...
            {!isLoading &&
                ...
                <div class="timeline-group">
                    <div class="timeline-group-header header-match clearfix">
                        ...
                        {(currentDate < pred_start) && (currentDate < pred_end) &&
                            <span class="timeline-label blue">Upcoming Match</span>
                        }
                        {(currentDate > pred_start) && (currentDate > pred_end) &&
                            <span class="timeline-label red">End Match</span>
                        }
                    ...
                    <div class="match-area">
                        ...
                        <div class="text-center">
                            ...
                            {(currentDate > pred_start) && (currentDate > pred_end) &&
                                <div class="text-center">
                                    <div class="btn btn-purple p-1 w-50 my-1 text-white mx-auto" onClick={() => history.push(`match/details/${match_id}`)} style={{ padding: '5px' }}>See Result</div>
